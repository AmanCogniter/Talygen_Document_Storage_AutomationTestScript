...
public class UserStoragePage extends WebBasePage {
    ...
    public void openUserStoragePage() {
        ...
        WebElement element = findElementVisibility(By.xpath("//ul[@data-p-name='Document Storage']//a[text()='Manage User Storage']"), 20);
        if (element != null) {
            //click(By.xpath("//ul[@data-p-name='Doc. Storage']//a[text()='User Storage']"), "User Storage menu", 20);
        	 click(By.xpath("//ul[@data-p-name='Document Storage']//a[text()='Manage User Storage']"), "User Storage menu", 20);
        } else {
            openUserStoragePage();
        }
    }
    ...
    public void clickDocStorageOption() {
    	staticWait(3000);
        WebElement displayScreen = findElementVisibility(By.xpath("//li[@data-name='Display Screen']"), 15);
        
        if (displayScreen.isDisplayed()) {
        	JavascriptExecutor jse = (JavascriptExecutor) driver;
    		jse.executeScript("arguments[0].scrollIntoView();", displayScreen);
            //click(By.xpath("//li[@class='menuitem']//a[text()='Doc. Storage']"), "Doc.Storage menu", 15);
        	click(By.xpath("//li[@data-name='Document Storage']/descendant::span[@class='fa  fa-angle-right gotosub']"), "Document Storage menu", 15);
        } else {
        	click(By.xpath("//li[@data-name='Document Storage']/descendant::span[@class='fa  fa-angle-right gotosub']"), "Document Storage menu", 15); 
        }
    }
    ...
    public void clickCancelButton() {
        click(By.xpath("(//a[@data-original-title='Cancel'])[1]"), "Cancel button for user 1", 15);
    }
