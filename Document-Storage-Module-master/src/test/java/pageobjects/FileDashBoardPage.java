...
public class FileDashBoardPage extends WebBasePage {
    ...
    public void openFileDashboard() {
        ...
        clickByJavascript(By.xpath("//a[@class='text-info indl' and text()='Dashboard']"), "Dashboard", 30);
		/*
		 * WebElement fileDashBoardOption = findElementVisibility(By.
		 * xpath("//ul[@data-p-name='Doc. Storage']//a[text()='File Dashboard']"), 30);
		 * if (fileDashBoardOption != null) { click(By.
		 * xpath("//ul[@data-p-name='Doc. Storage']//a[text()='File Dashboard']"),
		 * "File Dahsboard option", 15); } else { openFileDashboard(); }
		 */
    }
    ...
    public void salectType() {
    	//waitForVisibilityOfElement(By.xpath("//div[@class='custom-control custom-radio custom-control-inline']/input[@name='Department']"), 50);
        //click(By.xpath("//div[@class='custom-control custom-radio custom-control-inline']/input[@name='Department']"), "select type", 20);
    	WebElement selectDepartment = getDriver().findElement(By.xpath("//div[@class='custom-control custom-radio custom-control-inline']/input[@name='Department']"));
    	Actions action=new Actions(getDriver());
    	action.moveToElement(selectDepartment).click().perform();
    }
    ...
    public void verifyUpdatedDescription() {
    	...
    	String actualDescription = getText(By.xpath("//asp-label-mandatory/label[@for='FolderDesc']/ancestor::div[@class='form-group']/descendant::textarea"), 20);
    ...
    public void clickSingleDownloadIcon() {
       ...
       // click(By.xpath("//table[@id='tblFileList']//tbody//tr[1]//td[6]//a[contains(@class,'aFileDownload')]"), "Download Icon of file", 20);
        click(By.xpath("//a[@data-placement='right']/span[text()='Download']"), "Download Icon of file", 20);
    }
